...
//#define CONFIG_EXAMPLES_DIR "Tevo/Tornado/V1 (MKS Base)" //TITUS
...
#define STRING_CONFIG_H_AUTHOR "(titulebolide, Tevo Tornado V1)" // Who made the changes. //TITUS
...
//#define SHOW_CUSTOM_BOOTSCREEN //TITUS
